...
export type DocumentationSidebarItemPage = IDocumentationNestableSidebarItem &
	IDocumentationSidebarItem & {
...
/** Views implementation that will be returned if grouping by browser. */
export type GroupedByDocsBrowserViews = DocsViews &
	Node & {
...
/** Visitors implementation that will be returned if grouping by browser. */
export type GroupedByDocsBrowserVisitors = DocsVisitors &
	Node & {
...
/** Views implementation that will be returned if grouping by country. */
export type GroupedByDocsCountryViews = DocsViews &
	Node & {
...
/** Visitors implementation that will be returned if grouping by country. */
export type GroupedByDocsCountryVisitors = DocsVisitors &
	Node & {
...
/** Views implementation that will be returned if grouping by device type. */
export type GroupedByDocsDeviceTypeViews = DocsViews &
	Node & {
...
/** Visitors implementation that will be returned if grouping by device type. */
export type GroupedByDocsDeviceTypeVisitors = DocsVisitors &
	Node & {
...
export type GroupedByDocsGuideViews = DocsViews &
	Node & {
...
export type GroupedByDocsGuideVisitors = DocsVisitors &
	Node & {
...
export type GroupedByDocsOperatingSystemViews = DocsViews &
	Node & {
...
export type GroupedByDocsOperatingSystemVisitors = DocsVisitors &
	Node & {
...
export type GroupedByDocsPageViews = DocsViews &
	Node & {
...
export type GroupedByDocsPageVisitors = DocsVisitors &
	Node & {
...
export type GroupedByDocsPathViews = DocsViews &
	Node & {
...
export type GroupedByDocsPathVisitors = DocsVisitors &
	Node & {
...
export type GroupedByDocsReferrerHostViews = DocsViews &
	Node & {
...
export type GroupedByDocsReferrerHostVisitors = DocsVisitors &
	Node & {
...
export type GroupedByDocsTimeViews = DocsViews &
	Node & {
...
export type GroupedByDocsTimeVisitors = DocsVisitors &
	Node & {
...
export type UngroupedDocsViews = DocsViews &
	Node & {
...
export type UngroupedDocsVisitors = DocsVisitors &
	Node & {
...
export type PostFragment = {
	...
	slug: string;
	brief: string;
	author: { __typename?: 'User'; name: string; profilePicture?: string | null; username: string };
	coverImage?: { __typename?: 'PostCoverImage'; url: string } | null;
};

export type PostThumbnailFragment = {
	__typename: 'Post';
	id: string;
	title: string;
	slug: string;
...
export type PublicationFragment = {
	...
	features: {
		...
		customCSS: {
			...
			published?: {
				...
				post?: string | null;
				static?: string | null;
				homeMinified?: string | null;
				postMinified?: string | null;
				staticMinified?: string | null;
			} | null;
			draft?: {
				__typename: 'CustomCSS';
				homeMinified?: string | null;
		...
		newsletter: { __typename?: 'NewsletterFeature'; isEnabled: boolean };
		viewCount: { __typename?: 'ViewCountFeature'; isEnabled: boolean };
		readTime: { __typename?: 'ReadTimeFeature'; isEnabled: boolean };
		audioBlog: {
			__typename?: 'AudioBlogFeature';
			isEnabled: boolean;
			voiceType: AudioBlogVoiceType;
		};
		textSelectionSharer: { __typename?: 'TextSelectionSharerFeature'; isEnabled: boolean };
	};
	about?: { __typename?: 'Content'; html: string } | null;
	author: {
		__typename?: 'User';
		id: string;
		name: string;
	...
	preferences: {
		__typename?: 'Preferences';
		layout?: PublicationLayout | null;
		logo?: string | null;
		disableFooterBranding?: boolean | null;
		enabledPages?: {
			__typename?: 'PagesPreferences';
		...
		navbarItems: Array<{
			...
			type: PublicationNavigationType;
			series?: { __typename: 'Series'; id: string } | null;
			page?: { __typename: 'StaticPage'; id: string } | null;
		}>;
	};
	links?: {
		__typename?: 'PublicationLinks';
...
export type StaticPageQuery = {
	...
	publication?: {
		...
		staticPage?: {
			...
			ogMetaData?: { __typename?: 'OpenGraphMetaData'; image?: string | null } | null;
		} | null;
		features: {
			__typename?: 'PublicationFeatures';
			customCSS: {
...
export type RequiredStaticPageFieldsFragment = {
	__typename?: 'StaticPage';
	id: string;
	slug: string;
	title: string;
...
export type SubscribeToNewsletterMutation = {
	...
	subscribeToNewsletter: {
		__typename?: 'SubscribeToNewsletterPayload';
		status?: NewsletterSubscribeStatus | null;
	};
};
...
export type HomePageInitialQuery = {
	__typename?: 'Query';
	publication?: {
		__typename?: 'Publication';
		followersCount?: number | null;
		...
		headerColor?: string | null;
		descriptionSEO?: string | null;
		about?: { __typename?: 'Content'; markdown: string; html: string } | null;
...
export type NewsletterQuery = {
	...
	publication?: {
		...
		staticPage?: { __typename?: 'StaticPage'; id: string } | null;
		recentPosts: {
			__typename?: 'PublicationPostConnection';
			edges: Array<{
				__typename?: 'PostEdge';
...
export type MorePostsEdgeFragment = {
	__typename?: 'PostEdge';
	node: {
		__typename?: 'Post';
		id: string;
		...
		posts: {
			...
			edges: Array<{
				...
				node: {
					...
					slug: string;
					content: { __typename?: 'Content'; html: string };
					tags?: Array<{ __typename?: 'Tag'; id: string; name: string; slug: string }> | null;
	...
	searchPostsOfPublication: {
		...
		edges: Array<{
			...
			node: {
				...
				publication?: { __typename?: 'Publication'; title: string; url: string } | null;
			};
		}>;
...
export type SeriesPageInitialQuery = {
	__typename?: 'Query';
	publication?: {
		__typename: 'Publication';
		id: string;
		...
		series?: {
			...
			slug: string;
			cuid?: string | null;
			description?: { __typename?: 'Content'; html: string; markdown: string; text: string } | null;
...
export type SeriesPostsByPublicationQuery = {
	__typename?: 'Query';
	publication?: {
		__typename?: 'Publication';
		id: string;
		...
		series?: {
			...
			slug: string;
			coverImage?: string | null;
			description?: { __typename?: 'Content'; html: string } | null;
			posts: {
				__typename?: 'SeriesPostConnection';
				edges: Array<{
					__typename?: 'PostEdge';
		...
		post?: {
			...
			publication?: {
				...
				domainInfo: {
					...
					domain?: { __typename?: 'DomainStatus'; host: string; ready: boolean } | null;
				};
				features: {
					__typename?: 'PublicationFeatures';
					newsletter: { __typename?: 'NewsletterFeature'; isEnabled: boolean };
			...
			series?: { __typename?: 'Series'; id: string } | null;
			seo?: { __typename?: 'SEO'; title?: string | null; description?: string | null } | null;
			coverImage?: { __typename?: 'PostCoverImage'; url: string; isPortrait: boolean } | null;
			author: {
				__typename?: 'User';
				id: string;
				name: string;
				username: string;
				profilePicture?: string | null;
				socialMediaLinks?: { __typename?: 'SocialMediaLinks'; twitter?: string | null } | null;
				bio?: { __typename?: 'Content'; html: string } | null;
			};
			coAuthors?: Array<{
				__typename?: 'User';
				username: string;
...
export type SlugPostsByPublicationQuery = {
	...
	publication?: {
		...
		posts: {
			__typename?: 'PublicationPostConnection';
			edges: Array<{ __typename?: 'PostEdge'; node: { __typename?: 'Post'; slug: string } }>;
		};
		features: {
			__typename?: 'PublicationFeatures';
			customCSS: {
...
export const PostThumbnailFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'PostThumbnail' },
			...
			selectionSet: {
				...
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'cuid' } },
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'isAttributionHidden' } },
							],
						},
					},
				],
...
} as unknown as DocumentNode<PostThumbnailFragment, unknown>;
				...
				selections: [
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{ kind: 'Field', name: { kind: 'Name', value: 'static' } },
													],
												},
											},
										],
							...
							selections: [
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [{ kind: 'Field', name: { kind: 'Name', value: 'isEnabled' } }],
									},
								},
								{
									kind: 'Field',
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'audioBlog' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'isEnabled' } },
											{ kind: 'Field', name: { kind: 'Name', value: 'voiceType' } },
										],
									},
								},
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'textSelectionSharer' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [{ kind: 'Field', name: { kind: 'Name', value: 'isEnabled' } }],
									},
										...
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'isEnabled' } },
											{
												...
												selectionSet: {
													...
													selections: [
														{ kind: 'Field', name: { kind: 'Name', value: '__typename' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'homeMinified' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'postMinified' } },
														{ kind: 'Field', name: { kind: 'Name', value: 'staticMinified' } },
													],
												},
											},
											{
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'disableFooterBranding' } },
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'enabledPages' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
					...
					},
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'Field', name: { kind: 'Name', value: 'umamiWebsiteUUID' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'gaTrackingID' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'fbPixelID' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'hotjarSiteID' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'matomoURL' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'matomoSiteID' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'fathomSiteID' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'gTagManagerID' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'fathomCustomDomain' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'fathomCustomDomainEnabled' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'plausibleAnalyticsEnabled' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'koalaPublicKey' } },
								{ kind: 'Field', name: { kind: 'Name', value: 'msClarityID' } },
							],
						},
					},
				],
...
export const RequiredStaticPageFieldsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'RequiredStaticPageFields' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'StaticPage' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{ kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<RequiredStaticPageFieldsFragment, unknown>;
...
export const MorePostsEdgeFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'MorePostsEdge' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'PostEdge' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
							...
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'Post' } },
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'totalDocuments' } },
										],
									},
								},
							],
...
} as unknown as DocumentNode<MorePostsEdgeFragment, unknown>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
							...
							selections: [
								...
								},
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'hashnodeSubdomain' } },
											{
												kind: 'Field',
					...
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'coAuthors' },
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'Field', name: { kind: 'Name', value: 'username' } },
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'stickCoverToBottom' } },
							],
						},
					},
					{
										...
										selections: [
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{ kind: 'Field', name: { kind: 'Name', value: 'totalReactions' } },
														{
															kind: 'Field',
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'Publication' } },
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'staticPage' },
									arguments: [
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: 'NamedType',
							name: { kind: 'Name', value: 'SubscribeToNewsletterInput' },
						},
					},
				},
			],
...
} as unknown as DocumentNode<SubscribeToNewsletterMutation, SubscribeToNewsletterMutationVariables>;
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'HomePageInitial' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'host' } },
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'pinnedPost' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'PostThumbnail' } },
										],
									},
								},
							],
...
} as unknown as DocumentNode<HomePageInitialQuery, HomePageInitialQueryVariables>;
export const HomePagePostsDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'HomePagePosts' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'host' } },
				...
				},
				{
					...
					type: {
						kind: 'NamedType',
						name: { kind: 'Name', value: 'PublicationPostConnectionFilter' },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<HomePagePostsQuery, HomePagePostsQueryVariables>;
...
} as unknown as DocumentNode<NewsletterQuery, NewsletterQueryVariables>;
							...
							selections: [
								...
								},
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'StaticPage' } },
										],
									},
								},
							],
...
} as unknown as DocumentNode<PageByPublicationQuery, PageByPublicationQueryVariables>;
...
} as unknown as DocumentNode<PostsByPublicationQuery, PostsByPublicationQueryVariables>;
...
} as unknown as DocumentNode<MorePostsByPublicationQuery, MorePostsByPublicationQueryVariables>;
...
} as unknown as DocumentNode<PublicationByHostQuery, PublicationByHostQueryVariables>;
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'SearchPostsOfPublication' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'first' } },
				...
				},
				{
					...
					type: {
						...
						type: {
							kind: 'NamedType',
							name: { kind: 'Name', value: 'SearchPostsOfPublicationFilter' },
						},
					},
				},
				{
...
} as unknown as DocumentNode<SearchPostsOfPublicationQuery, SearchPostsOfPublicationQueryVariables>;
export const SeriesPageInitialDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
...
} as unknown as DocumentNode<SeriesPageInitialQuery, SeriesPageInitialQueryVariables>;
export const SeriesPostsByPublicationDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			...
			variableDefinitions: [
				...
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'seriesSlug' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
					},
									...
									arguments: [
										{
											kind: 'Argument',
											name: { kind: 'Name', value: 'slug' },
											value: { kind: 'Variable', name: { kind: 'Name', value: 'seriesSlug' } },
										},
									],
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'Series' } },
										],
									},
								},
							],
...
} as unknown as DocumentNode<SeriesPostsByPublicationQuery, SeriesPostsByPublicationQueryVariables>;
							...
							selections: [
								...
								},
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'PostFull' } },
										],
									},
								},
							],
...
} as unknown as DocumentNode<SinglePostByPublicationQuery, SinglePostByPublicationQueryVariables>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'postsCount' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'Int' } },
					},
				...
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'postsAfter' } },
					type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
				},
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'staticPagesCount' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'Int' } },
					},
									...
									arguments: [
										{
											kind: 'Argument',
											name: { kind: 'Name', value: 'first' },
											value: { kind: 'Variable', name: { kind: 'Name', value: 'postsCount' } },
										},
										{
											kind: 'Argument',
											name: { kind: 'Name', value: 'after' },
											value: { kind: 'Variable', name: { kind: 'Name', value: 'postsAfter' } },
										},
									],
									selectionSet: {
										kind: 'SelectionSet',
...
} as unknown as DocumentNode<MoreSitemapPostsQuery, MoreSitemapPostsQueryVariables>;
...
} as unknown as DocumentNode<SlugPostsByPublicationQuery, SlugPostsByPublicationQueryVariables>;
export const TagInitialDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'TagInitial' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'slug' } },
...
} as unknown as DocumentNode<TagInitialQuery, TagInitialQueryVariables>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'tagSlug' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } },
					},
												...
												fields: [
													{
														...
														value: {
															kind: 'ListValue',
															values: [
																{ kind: 'Variable', name: { kind: 'Name', value: 'tagSlug' } },
															],
														},
													},
												],
...
} as unknown as DocumentNode<TagPostsByPublicationQuery, TagPostsByPublicationQueryVariables>;
